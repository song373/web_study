...
@Controller
public class RedirectForwara01Controller {
	...
	public String re4(HttpServletRequest request) {
		...
		return "re/re4"; //요청 /re4 -> 화면(view) re4 -> 페이지 내부->re2
	}
	...
	public String re5(HttpServletRequest request) {
		...
		// redirect 주소창에 들어갈 경로! localhost:8080 "re/re"
	}
	...
	public String re6(HttpServletRequest request) {
		...
		return "redirect:/re/re2"; // RequestMapping 에 해당하는 경로를 생성	
}
	...
	public String re7(HttpServletRequest request, RedirectAttributes ra) {
		...
		// -> 연결된 서버측 메소드에서도 경로에 있는 Parameter 확인
		ra.addFlashAttribute("msg", request.getParameter("msg")); //경로에 파라미터 
			//redirect 요청 주소는 그대로
