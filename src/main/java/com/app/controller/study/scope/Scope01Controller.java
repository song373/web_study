...
public class Scope01Controller {
	...
	Scope01Controller(ViewData01Controller viewData01Controller, ViewData01Controller viewData01Controller1) {
	...
	public String scope4(HttpSession session) {
		...
		session.invalidate(); //sessopm scope 에 저장된 모든 속성(키) 삭제 (세션 초기화)
